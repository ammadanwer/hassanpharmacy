...
class Batch(Base, IdIntPK, TimestampMixin):
    ...
    entered_cost_price: Mapped[Optional[float]] = mapped_column(Numeric(12, 2), nullable=True)
    entered_sell_price: Mapped[Optional[float]] = mapped_column(Numeric(12, 2), nullable=True)
